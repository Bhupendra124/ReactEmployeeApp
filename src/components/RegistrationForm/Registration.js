...

{
    constructor()
    {
        ...
        // this is json object stored one by one 
        this.state = {
             id: '',
            name: '',
           // departmentValue: [],
                            ...
                            <div className="profile-radio-content">
                                <label>
                                    <input type="radio" id="profile1" name="profile" onChange={this.changeValue}
                                            ref={this.profileRef1} value="./assets/Ellipse -3.png" />
                                ...
                                <label>
                                    <input type="radio" id="profile2" name="profile" onChange={this.changeValue}
                                            ref={this.profileRef2} value="..\assets\Ellipse 1.png" />
                                ...
                                <label>
                                    <input type="radio" id="profile3" name="profile" onChange={this.changeValue}
                                            ref={this.profileRef3} value="..\assets\Ellipse -8.png" />
                                ...
                                <label>
                                    <input type="radio" id="profile4" name="profile" onChange={this.changeValue}
                                            ref={this.profileRef4} value="..\assets\Ellipse -7.png" />
